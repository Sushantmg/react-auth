...
function ProductDetail() {
    ...
    return (
        <div className="p-6">
            <h1 className="text-3xl font-semibold text-gray-800 mb-6">{product.title}</h1>
            ...
            <p className="text-indigo-600 font-semibold mt-3">Category: {product.category}</p>
            <p className="text-indigo-600 font-semibold mt-3">Rating: {product.rating?.rate || 'N/A'} ({product.rating?.count || 0} reviews)</p>
